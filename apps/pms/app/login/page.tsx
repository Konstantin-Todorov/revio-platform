...
export const metadata = { title: "Sign in · RevioPMS" };
    ...
    <div className="flex min-h-screen items-stretch bg-surface-muted">
      ...
      <div className="relative hidden w-1/2 flex-col justify-between bg-gradient-to-br from-brand-900 to-brand-800 p-12 text-white lg:flex">
        <div className="flex items-center gap-2.5">
          ...
          <div className="leading-none">
            <div className="text-[17px] font-bold">Revio<span className="text-product-mark">PMS</span></div>
            <div className="mt-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-white/45">Operations</div>
          </div>
        </div>
        <div>
          <h1 className="max-w-sm text-[28px] font-bold leading-tight tracking-tight">Run the property. Every room, every day.</h1>
          <p className="mt-3 max-w-sm text-[14px] text-white/60">Front desk, housekeeping and folios over the same shared inventory — check a guest in and the whole platform knows.</p>
        </div>
        <div className="text-[12px] text-white/40">© Revio · operations</div>
      </div>
      ...
      <div className="flex w-full items-center justify-center p-6 lg:w-1/2">
        <div className="w-full max-w-sm">
          ...
          <h2 className="text-[20px] font-bold tracking-tight text-ink-900">Sign in to RevioPMS</h2>
          <p className="mb-6 mt-1 text-[13px] text-ink-500">Welcome back — run your front desk.</p>
