...
export const metadata = { title: "Two-factor · RevioPMS" };
      ...
      <div className="relative hidden w-1/2 flex-col justify-between bg-gradient-to-br from-brand-900 to-brand-800 p-12 text-white lg:flex">
        <div className="flex items-center gap-2.5">
          ...
          <div className="leading-none">
            ...
            <div className="mt-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-white/45">Property Management</div>
          </div>
        </div>
        <div>
