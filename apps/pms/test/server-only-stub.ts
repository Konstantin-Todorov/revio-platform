 ...
 * every server module in RevioPMS is permanently untestable. The calendar's date maths went untested
 * for exactly that reason, and shipped a night count that changed when you scrolled the page.
 */
export {};
