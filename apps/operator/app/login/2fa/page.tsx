...
export const metadata = { title: "Two-factor · Revio Operator" };

/**
 * Step two of signing in (N4).
 *
 ...
 * both get the same answer: back to the start. There is no state to preserve, because a password
 * proven six minutes ago is not proven now.
 */
      ...
      <div className="relative hidden w-1/2 flex-col justify-between bg-brand-900 p-12 text-white lg:flex">
        ...
        <div>
          ...
          <p className="mt-3 max-w-sm text-[14px] text-white/60">
            This console can read every hotel on the platform, so a password on its own is not enough to open it.
          </p>
        </div>
