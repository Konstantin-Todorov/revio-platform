  ...
  return (
    <>
      ...
      <Modal open={open} onClose={() => setOpen(false)} title="Invite a team member">
        <p className="mb-3 text-[12.5px] text-ink-500">They’ll get access to this hotel, scoped to their role. An invitation goes to their email and they choose their own password.</p>
