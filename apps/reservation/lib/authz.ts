 ...
 *
 * Before this file existed, exactly one action in RevioCRS checked a role: the staff-management
 * one. A `read_only` account could re-price a season, take a room off sale, or cancel somebody
 * else's booking, because every other action simply did the work.
 *
 * ## How to use it
 *
 ...
 * RevioLink, because the roles are one shared identity across the platform.
 */
