  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        ink: { 900: "#1c2733", 800: "#2b3542", 700: "#3f4753", 600: "#4d5764", 500: "#5b6675", 400: "#7d8aa3", 300: "#9aa3b1", 200: "#c9d0da", 100: "#e4e8ee" },
        surface: { DEFAULT: "#ffffff", page: "#f7f8fa", muted: "#f1f3f6", sunken: "#e7eaef", border: "#dde4ee" },
        success: { 700: "#0b5c3e", 600: "#0f7a52", 500: "#1f9d6b", 100: "#cdebdd", 50: "#e3f4ec" },
        warning: { 800: "#7a4610", 700: "#9a5a14", 600: "#e0822b", 500: "#e0a23b", 200: "#f5dcb0", 100: "#f9ebd2", 50: "#fbf1e0" },
        danger: { 700: "#8c2820", 600: "#b53528", 500: "#d6493b", 200: "#f3c4bf", 100: "#f8dcd8", 50: "#fbe9e7" },
        info: { 500: "#0d9aa8" },
        accent: { 700: "#4a3290", 600: "#5b3fb0", 500: "#7c5cdb", 100: "#e0d7f7", 50: "#efe9fb" },

        /*
         * The one scale that differs between the four apps — RevioCRS.
         *
         * The indigo of the RevioCRS tile. The system of record.
         *
