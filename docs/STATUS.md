...
> stands on 2026-09-25 (RevioCRS in Bulgarian: parts 1–4 done behind `CRS_TRANSLATED = false`,
> part 5 — switching it on — next; and the 2026-09-26 client-deletion incident, fixed), the founder's agreed order after it, and the standing rules.
