...
| [BOOKING-ENGINE-ADDENDUM.md](BOOKING-ENGINE-ADDENDUM.md) | Booking engine = a CRS Distribution surface; the three design-for-now seams (public search/create API, source=Direct, direct-channel flag) — all three shipped in phase A. Still binding on placement and boundaries; **the deferral it describes was lifted 2026-07-27**. |
| [BOOKING-ENGINE-DESIGN.md](BOOKING-ENGINE-DESIGN.md) | **RevioDirect design + build plan** (2026-07-26, signed off): market research, where Revio wins structurally, the four locked founder decisions (Revio-hosted page · card guarantee not prepayment · the money is the hotel's · photos in object storage), and phase **K**. **K1–K4 shipped; K5–K9 open.** Living description of what exists: `apps/booking/CLAUDE.md`. |
...
## Refinement round — founder docs 2026-07-20 (post-V2) — ✅ **G · H · J all shipped**
