...
### 3. Payments are mocked — no money can actually move
...
### 4. Fiscalization (Bulgaria) — a legal gate, not a feature
...
### 5. Channex production certification
...
### 6. A real hotel's OTA credentials
...
### 9. Error monitoring and uptime alerts
...
### 10. Backups are drilled, not just taken
...
### 11. Scheduler for the background jobs
...
### 14. Onboarding a real property end to end, once, on purpose
...
### 17. Support and incident basics
