...
window.REVIO_DOCS_DRAFTS = {
  'starting-free-trial': {title:'Starting your free trial',group:'Start here',navGroup:'Account and trial',section:'guides',lead:'Try RevioLink, RevioCRS and RevioPMS for 30 days. Keep only the ones you use — pay for those alone.',review:'Brief checked · UI review pending',next:'signing-in',sections:[
    ['before','Before you start','<p>Use your work email and have your hotel name ready. No card is required. One account gives your hotel access to the trial products; choosing where to begin does not commit you to buying them all.</p>'],
    ['signup','Create your account','<ol class="steps"><li><strong>Open Start free trial</strong><p>Go to <a href="https://cm.reviosoft.app/signup">Revio signup</a>. The address uses the channel-manager domain, but registration is for your Revio account.</p></li><li><strong>Tell us about your hotel</strong><p>Enter your hotel name, your name and work email. Choose the task you most want to improve; it determines the product you open first.</p></li><li><strong>Follow the confirmation instructions</strong><p>For a new signup, check your email and open the confirmation link to choose a password. An unconfirmed signup is not yet a running trial.</p></li><li><strong>Sign in and begin</strong><p>Use your email and password at the appropriate product. Explore a small, checked setup before connecting live distribution.</p></li></ol>'],
    ['email','If the email or link does not work','<p>The confirmation link expires after 7 days and works once. Check spam and the address you entered. If you started but never confirmed, submit the same address again for a fresh link; use the newest email because the old link is replaced. For an active account, sign in or use Forgot password on the sign-in page. Contact <a href="https://reviosoft.app/support">support</a> if you still cannot get access.</p>'],
    ['existing','If you already have an account','<p>Signup can tell you that the address already has a Revio account. Follow the sign-in or password-reset option instead of registering again. Repeating signup does not start a second trial. Each product can be trialled once.</p>'],
    ['choose','Keep only what helps your hotel','<p>You can explore all three products. Keep only the ones you use — pay for those alone. Tell Revio which products you want to keep; there is no self-serve checkout. Read <a href="?page=trial-ending">What happens when the trial ends</a> before deciding.</p>'],
  ]},
  'signing-in': {title:'Signing in to the right product',group:'Start here',navGroup:'Account and trial',section:'guides',lead:'One account, separate product sign-in pages. Choose the workspace for the job you need to do.',review:'Brief checked · UI review pending',next:'trial-ending',sections:[
    ['choose','Choose your workspace','<p>Open the <a href="https://reviosoft.app/login">website Log in page</a>. It offers three product links and may remember your last choice in this browser. It does not ask for your email to look up your products.</p><ul><li><strong>RevioLink:</strong> channel distribution, availability, rates and delivery checks.</li><li><strong>RevioCRS:</strong> reservations, guests and commercial reporting.</li><li><strong>RevioPMS:</strong> front desk, housekeeping and guest folios.</li></ul>'],
    ['credentials','Use the same account, sign in separately','<p>Your email and password identify the same person across the products. Sessions are separate: being signed into one product does not mean you are signed into another. Central login is not available yet. Product access and your staff permissions determine what you can use.</p>'],
    ['direct','RevioDirect is different','<p>RevioDirect is the guest-facing booking page, configured through RevioCRS. It is not a fourth staff login. Guests do not use your staff credentials to book.</p>'],
    ['access','If a product does not open','<p>An expired trial does not delete your account. Sign in to see the trial-ended screen and any products still available. “I want to keep it” sends a request; it does not activate paid access. A suspended account must be resolved with Revio support. If you have never used the requested product but already have another, you may be directed to that available product.</p>'],
    ['help','If you cannot sign in','<p>Check your email and password, then use Forgot password if needed. Sign-in and reset responses do not disclose account existence to strangers. Never send a password or confirmation link to support. Tell us which product you tried and the error shown.</p>'],
  ]},
  'trial-ending': {title:'What happens when the trial ends',group:'Start here',navGroup:'Account and trial',section:'guides',lead:'Keep only the products you use — pay for those alone. Trial expiry does not delete your hotel data.',review:'Brief checked · UI review pending',next:'starting-free-trial',sections:[
    ['ends','Trials end per product','<p>The initial trial lasts 30 days. Product trials are independent: an expired product becomes locked while any products you have kept remain available. You can still sign in. The trial-ended screen gives the end date and links to products that still open. Ending the trial does not delete your rooms, rates or reservations.</p>'],
    ['keep','Ask to keep a product','<ol class="steps"><li><strong>Choose what you use</strong><p>You do not have to keep every product you tried.</p></li><li><strong>Send your request</strong><p>Choose “I want to keep it” on the ended-trial screen, or <a href="https://reviosoft.app/support">contact Revio</a>.</p></li><li><strong>Arrange activation with the team</strong><p>The button records your request only. There is no self-serve checkout and it does not itself switch access back on or collect payment.</p></li></ol>'],
    ['first-month','Your first paid month','<p>For a new paying hotel converting its first trial, the joining month is charged from the conversion day to the end of that calendar month. You are not charged retrospectively for trial days. Subsequent months are full calendar months. For example, a first conversion on September 20 covers September 20–30: 11 of 30 days of the applicable monthly subscription.</p>'],
    ['additional','Adding another product later','<p>The joining-month rule belongs to the hotel’s first paid relationship, not to every added product. If your hotel already pays for a product and converts a further product’s trial later, that additional product is charged for the full conversion month. Ask the team to confirm the billing before activating it.</p>'],
    ['direct-fee','Direct-booking fees','<p>RevioDirect has a 2% usage fee on bookings produced by its booking engine. This percentage is not prorated like a monthly subscription. For the joining month, the eligible booking dates exclude the free-trial period.</p>'],
    ['return','If you return later','<p>Use your existing account instead of signing up again. One trial is available per product; a repeated signup does not reset it. Contact Revio to discuss access to a product whose trial has already ended.</p>'],
  ]},
